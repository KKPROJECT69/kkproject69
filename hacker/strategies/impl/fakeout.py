...
class Fakeout(Strategy):
    ...
    def analyze(self, analysis: MarketAnalysis, candles: list[Candle]) -> StrategyResult:
        ...
        if prev.high > analysis.breakout_level and prev.close < analysis.breakout_level:
            if last.is_bearish:
        ...
        if prev.low < analysis.breakdown_level and prev.close > analysis.breakdown_level:
            if last.is_bullish:
                return StrategyResult(
